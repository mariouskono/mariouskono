      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-12 flex justify-between items-center relative">
          ...
          <div className="flex items-center z-50 relative">
            {/* Hamburger / Close button — min 44×44px touch target */}
            <button
              onClick={() => setIsMenuOpen(!isMenuOpen)}
              className="flex items-center justify-center transition-all duration-300 hover-target ml-4 border-2 border-slate-900 bg-[#4ade80] shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_0px_rgba(15,23,42,1)]"
            ...
            {/* DROPDOWN MENU — state-based (works on touch) */}
            <div
                ...
                {navLinks.map((link, index) => (
                  <li key={index}>
                    <a
                      ...
                      className="block px-4 py-3 text-sm md:text-base font-display font-black uppercase text-slate-900 hover:bg-[#38bdf8] border-2 border-transparent hover:border-slate-900 transition-all duration-200 hover-target"
